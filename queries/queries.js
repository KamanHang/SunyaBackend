...
const addComment = "INSERT INTO comments ( comment_desc,user_email,post_id ) VALUES($1,$2,$3) "

const getPost = "SELECT post_id,post_desc, up_vote, posts.image AS post_image, posted_date, post_time, user_name, users.image AS user_image FROM posts INNER JOIN users ON posts.user_email = users.email;"
